---
name: flutter-modify
description: Perform structured modification of Flutter or Dart project code with design document and implementation plan.
...
- [ ] After committing the change, if an app is running, press `r` in the terminal to hot reload.
...
- [ ] Update any CLAUDE.md file in the project directory so that it still correctly describes the app, its purpose, and implementation details and the layout of the files.
